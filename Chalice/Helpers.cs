namespace EverybodyCodes
{
    public static class Helpers
    {
        ...
        public static string GetQuestFromNamespace(object o)
        {
            var nameSpace = o.GetType().Namespace;

            var questCount = nameSpace?.Split('_')[1].Trim();

            if (questCount == null)
            {
                return "unknown quest number";
            }

            return questCount;
        }

        public static string GetPartFromClass(object o)
        {
            var c = o.GetType().Name;
